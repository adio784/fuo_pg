                     ...
                     <div class="progress" style="height: 7px;">
                      ...
                      <div class="progress" style="height: 7px;">
                        ...
                        <form action="../app/function/application_process.php" method="POST">
                          <input type="hidden1" name="acceptance_fee" value="60000">
                          <input type="hidden1" name="email_address" value="<?= $User->email; ?>">
                          <input type="hidden1" name="acceptanceForm" value="<?= uniqid(); ?>">
                          <input type="hidden" name="purpose" value="Acceptance fee">
                          <button type="submit" class="btn btn-primary"> Proceed to pay acceptance </button>
                        </form>
                        <?php } ?>
