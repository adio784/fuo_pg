            ...
            <ul class="navbar-nav align-items-center right-nav-link">
                ...
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                        <span class="user-profile"><img src="admissionUploads/<?php echo $User->passport ?>"
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="javaScript:void();">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                            src="admissionUploads/<?php echo $User->passport ?>" alt="user avatar">
                                    </div>
                        ...
                        <li class="dropdown-divider"></li>
                        <a href="my_application" class="dropdown-item"><i class="icon-wallet mr-2"></i> My Application
                        </a>
                        <li class="dropdown-divider"></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-lg-7 col-xl-8">
                    <div class="card">
                        <div class="card-header">Welcome Back ! <?php echo $fname; ?>
                            (<?php echo $User->application_id ?>)
                                ...
                                <div class="col-lg-7 col-xl-8 border-right">
                                    <div class="row">
                                        <div class="col-lg-5 col-xl-5">
                                            <div class="card-body">
                                                <img src="admissionUploads/<?php echo $User->passport ?>" alt=""
                                        ...
                                        <div class="col-lg-7 col-xl-7">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <p><?php echo $fname; ?></p>
                                                    <p>
                                                        <? //$_SERVER['HTTP_HOST']."/fuo_pg/admission_portal/app/function/application_process.php?accept=1&&"; 
                              ?>
                                                    </p>
                                                </div>
                                ...
                                <div class="col-lg-5 col-xl-4">
                                    ...
                                    <hr>
                                    <p class="mt-3">Application Form <span
                                            class="float-right badge badge-info">Completed</span></p>
                                    <div class="progress" style="height: 7px;">
                      ...
                      <div class="progress" style="height: 7px;">
                          <div class="progress-bar bg-success progress-bar-striped" role="progressbar" style="width: 60%"></div>
                                    ...
                                    <hr>
                                    <p class="mt-3"> Admission Status <span
                                            class="float-right badge badge-warning">Pending</span></p>
                                    <div class="progress" style="height: 7px;">
                                    ...
                                    <hr>
                                    <form action="../app/function/application_process.php" method="POST"
                                        id="paymentForm">
                                        ...
                                        <button type="submit" id="paymentBtn" class="btn btn-primary"> Proceed to pay
                                            acceptance </button>
                                    </form>

                                    <?php } elseif ($User->application_status == "admitted" && $Acceptancepay == "success") { ?>
                                    <hr>
                                    <button type="submit" id="paymentBtn" class="btn btn-info"> Print Acceptance Letter
                                    </button>
                                    <?php } else {
                      echo "";
                    } ?>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="align-self-center w-circle-icon rounded gradient-ibiza">
                                    <i class="icon-speech text-white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      foreach ($Receipts as $Receipt) {
                        $i++; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge text-white shadow <?php if ($Receipt->payment_status != "") {
                                                                      echo 'shadow-danger gradient-bloody';
                                                                    } else {
                                                                      echo 'shadow-success gradient-quepal';
                                                                    } ?>"><?php echo $Receipt->payment_status ?></span>
                                        </td>
                                        <td><?php echo date('F d, Y', strtotime($Receipt->created_at)) ?></td>
                                        <td>
                                            <?php //if ($Receipt->payment_status != ""){
                            ?>
                                            <form action="receipt" method='POST'>
                                                <input type="hidden" name="ref"
                                                    value="<?php echo $Receipt->transactionId ?>">
                                                <button type="submit"
                                                    class="btn btn-info shadow-info waves-effect waves-light m-1"><i
                                                        class="fa fa-print font-lg"></i> Print</button>
                                                <?php //} else { 
                              ?>
                                            </form>
...
$(document).ready(function() {
    ...
    var authID = "<?php if (isset($_SESSION['user_id'])) {
    ...
    var pay_success =
        "<?php if (isset($_GET['pay_success']) != "") {
          echo $_GET['pay_success'];
        } else {
          echo "";
        } ?>";
    var pay_error = "<?php if (isset($_GET['error']) != "") {
                        echo $_GET['error'];
                      } else {
                        echo "";
                      } ?>";
