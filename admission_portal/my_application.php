                    ...
                    <div class="profile-card-3">
                        <div class="card">
                            <div class="user-fullimage">
                                <img src="admissionUploads/<?php echo $User->passport ?>" alt="user avatar"
                                    class="card-img-top">
                                <div class="details">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col p-2">
                                        ...
                                        <small
                                            class="mb-0 font-weight-bold"><?php echo date('g M, Y', strtotime($User->date_of_birth) ) ?></small>
                                    </div>
                                </div>

                                <hr>
                                <a href="javascript:void():"
                                    class="btn btn-primary shadow-primary btn-sm btn-round waves-effect waves-light m-1"><?php echo $User->state ?></a>
                                <a href="javascript:void():"
                                    class="btn btn-outline-primary btn-sm btn-round waves-effect waves-light m-1"><?php echo $User->country ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                                <li class="nav-item">
                                    <a href="javascript:void();" data-target="#profile" data-toggle="pill"
                                        class="nav-link active"><i class="icon-user"></i> <span class="hidden-xs">MY
                                            APPLICATIONS</span></a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane active" id="profile">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h6>Origin</h6>
                                            <a href="javascript:void();"
                                                class="badge badge-dark badge-pill p-2">Country:
                                                <?php echo $User->country_of_origin ?></a>
                                            <a href="javascript:void();" class="badge badge-dark badge-pill p-2">State:
                                                <?php echo $User->state_of_origin ?></a>
                                            <a href="javascript:void();" class="badge badge-dark badge-pill p-2">LGA:
                                                <?php echo $User->local_government ?></a>
                                            <hr>
                                            <h6>Residence</h6>
                                            <span class="badge badge-primary p-2"><i class="fa fa-user"></i> Country:
                                                <?php echo $User->country ?></span>
                                            <span class="badge badge-success p-2"><i class="fa fa-cog"></i> State:
                                                <?php echo $User->state ?></span>
                                            <span class="badge badge-info p-2"><i class="fa fa-eye"></i> City:
                                                <?php echo $User->lga ?></span>
                                        </div>
                                        <div class="col-md-12">
                                            <h5 class="mt-2 mb-3"><span
                                                    class="fa fa-clock-o ion-clock float-right"></span> Application</h5>
                                            <table class="table table-hover table-striped">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <strong>Programme: </strong>
                                                            <?php echo $Prog->programme_title ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
