...
$rquery->execute([$departmentId, 'recommend']);
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card shadow-sm border-0">
            <div class="card">
                <div class="card-header"><i class="fa fa-table"></i> List of Admitted Applicants</div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered" id="lecturerTable">
                            ...
                            <tbody>
                                ...
                                if ($rcount < 1) {
                                    ...
                                    echo "<tr> <td align='center' colspan='7'> <strong> No record found !!! </strong> </td> </tr>";
                                } else {
