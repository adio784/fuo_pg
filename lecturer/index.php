...
<head>
    ...
    <title>Welcome: FUO - Lecturer's Office</title>
		 ...
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign In</div>
			...
			<div class="form-row mr-0 ml-0">
			 ...
			 <button type="button" class="btn btn-primary shadow-primary btn-round btn-block waves-effect waves-light">Sign In</button>
