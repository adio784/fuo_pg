    ...
    <div class="container-fluid">
     ...
     <div class="row">
         <div class="col-12 col-lg-7 col-xl-8">
           <div class="card">
		     <div class="card-header">Welcome Back ! <?php echo $fullname; ?> (<?php echo $User->matric_no ?>)
				 
				</div>
              <div class="card-body">
                 <div class="row">
                   <div class="col-lg-12 col-xl-12 border-right">
                        <div class="row">
                            <div class="col-lg-5 col-xl-5">
                                <div class="card-body">
                                    <img src="../admission_portal/admissionUploads/<?php echo $User->passport ?>" alt="" class="card-img-top w-100">
                                </div>
                            </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="media-body text-left">
                ...
                <span> Todays Date: <strong> <?= date('Y-m-d') ?> </strong></span>
              </div>
