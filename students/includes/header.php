  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true" class=" border-right border-light shadow-none">
     <div class="brand-logo">
      <a href="student_home">
        <img src="../assets/images/logo/logo.jpg" style="height: 50px;">
        <h5 class="logo-text" style="font-size: 22px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight:bolder">Student Portal</h5>
     </a>
	 </div>
	 <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="students_result" class="waves-effect">
    ...
    <header class="topbar-nav">
        <nav class="navbar navbar-expand fixed-top bg-body border-bottom border-light shadow-none">
            ...
            <ul class="navbar-nav align-items-center right-nav-link">
                ...
                <i class="icon-bell"></i><span class="badge badge-danger badge-up"><?= '10' ?></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javaScript:void();">
                      <div class="media">
                          ...
                          <h6 class="mt-0 msg-title">New Notification </h6>
                          <p class="msg-info"><?= '' ?> </p>
                          </div>
                      </div>
                    </a>
                ...
                <li class="dropdown-item user-details">
                    <a href="javaScript:void();">
                    <div class="media">
                        <div class="avatar"><img class="align-self-start mr-3" src="<?= $passport ?>" alt="user avatar"></div>
                        <div class="media-body">
