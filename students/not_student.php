		...
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Change Default Password</div>
		    <form method="POST" action="../app/function/student_actions.php" id="studentLogin">
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  <label for="exampleInputUsername" class="sr-only">Old Password</label>
				  <input type="text" name="oldPassword" id="exampleInputUsername" class="form-control form-control-rounded" placeholder="Old Password" required>
            ...
            <div class="form-group">
                <div class="position-relative has-icon-right">
                    ...
                    <input type="password" name="newPassword" id="exampleInputPassword" class="form-control form-control-rounded" placeholder="Confirm Password" required>
                    <div class="form-control-position">
                        <i class="icon-lock"></i>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="position-relative has-icon-right">
                    ...
                    <input type="password" name="confirmPassword" id="exampleInputPassword" class="form-control form-control-rounded" placeholder="Confirm Password" required>
                    <div class="form-control-position">
                        <i class="icon-lock"></i>
                    </div>
                </div>
  ...
  <script>
    $(document).ready(function () {
        ...
        $('#studentLogin').submit(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '../app/function/student_actions.php', 
                data: formData,
