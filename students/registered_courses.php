              ...
              <table id="default-datatable" class="table table-bordered">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="delete_acourse?admit=<?= $appID ?>" class="btn btn-warning shadow-warning waves-effect waves-light m-1" onclick="return Confirm('Are you sure you want to proceed ?')"><i class="fa fa-trash font-lg"></i> Remove</a>
                            </td>
