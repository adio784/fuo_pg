            ...
            <div class="col-12 col-lg-5 col-xl-3 border-light">
                <div class="card-body">
                    ...
                    <div class="media-body text-left">
                        <span>Search <br>by session</span>
                    </div>
            ...
            <div class="col-12 col-lg-7 col-xl-7 border-light">
                <div class="card-body">
                    ...
                    <div class="media-body text-left">
                        ...
                        <button type="submit" class="btn btn-info shadow-info waves-effect waves-light ml-1"> Proceed </button>
        ...
        <div class="row row-group m-0">
          <div class="col-12 col-lg-5 col-xl-3 border-light">
              <div class="card-body">
                <div class="media">
                  <div class="media-body text-left">
                    <span><strong> Total <br>CGPA </strong></span>
                  </div>
                  <div class="align-self-center w-circle-icon rounded bg-info shadow-info">
                    <i class="text-white"><?= $TApp->num ?></i>
                  </div>
