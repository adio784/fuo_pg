...
<head>
  ...
  <title>PG School :| Welcome to Fountain University, School of Post Graduate</title>
  <!--favicon-->
    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-lg-4 text-center text-lg-left">
          <a class="text-color mr-3" href="callto:+443003030266"><strong>CALL</strong> +234 70 356 70556 </a>
  ...
  <div class="navigation w-100">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light p-0">
        <a class="navbar-brand" href="index"><img src="assets/images/logo.jpg" alt="logo" class="w-50"></a>
