    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
          <h4 class="text-white mb-5">PG SCHOOL</h4>
          <ul class="list-unstyled">
            <li class="mb-3"><a class="text-color" href="#">About Us</a></li>
            <li class="mb-3"><a class="text-color" href="#">Our Lecturers</a></li>
            <li class="mb-3"><a class="text-color" href="#">Contact</a></li>
            <li class="mb-3"><a class="text-color" href="#">Blog</a></li>
          </ul>
        </div>
        <!-- links -->
        <div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-5 mb-md-0">
        ...
        <!-- support -->
        <div class="col-lg-2 col-md-5 col-sm-4 col-6 mb-5 mb-md-0">
          <h4 class="text-white mb-5">PRIVACY POLICY </h4>
          <ul class="list-unstyled">
            <li class="mb-3"><a class="text-color" href="#">Privacy Policy</a></li>
            <li class="mb-3"><a class="text-color" href="#">Documentation</a></li>
            <li class="mb-3"><a class="text-color" href="#">Career and Opportunities</a></li>
          </ul>
        </div>
        <!-- support -->
        <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
          <h4 class="text-white mb-5">ADMISSIONS </h4>
          <ul class="list-unstyled">
            <li class="mb-3"><a class="text-color" href="#">How to Apply</a></li>
            <li class="mb-3"><a class="text-color" href="#">Payment Schedule</a></li>
            <li class="mb-3"><a class="text-color" href="#">Academic Calendar</a></li>
            <li class="mb-3"><a class="text-color" href="#">Dress Code</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-sm-7 text-sm-left text-center">
          <p class="mb-0">Copyright
            ...
            © Fountain University | PG School | Theme By <a href="https://themefisher.com">themefisher.com</a></p> . All Rights Reserved.
        </div>
