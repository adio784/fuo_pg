...
class KycController extends Controller
{
    ...
    public function verify_bvn(Request $request)
    {
        ...
        if($Kyc == null)
        {
            ...
            $newDetails = [
                "bvn"       => $request->bvn,
                // "business"  => "645e455b2706198180ab3a49"//  live: 645e400f2706198d65ab391b   test: 645e4011e86a9f78e03e4259
            ];
            ...
            if( isset($response->success) ){
                ...
                if($response->data->firstName == $firstName  && $response->data->lastName == $lastName)
                {
