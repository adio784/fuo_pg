...
<head>
	...
	<title>Welcome: FUO - Lecturer Office</title>
					...
					<form id="loginform" method="POST">
						<div class="form-group">
							<div class="position-relative has-icon-right">
								...
								<input type="text" name="username" id="exampleInputUsername" class="form-control form-control-rounded" placeholder="Username" required>
						...
						<div class="form-group">
							<div class="position-relative has-icon-right">
								...
								<input type="password" name="password" id="exampleInputPassword" class="form-control form-control-rounded" placeholder="Password" required>
								<div class="form-control-position">
									<i class="icon-lock"></i>
								</div>
							</div>
				...
				$.ajax({
					...
					success: function(response) {
						...
						if (response.status == 'success') {
							...
							if (nextLogin == 'admin' || nextLogin == 'super_admin' || nextLogin == 'lecturer') {
								window.location = 'home';
							} else {
								alert("Error! You are not allowed to view the page you are trying to access" + nextLogin);
							}
